              ...
              <>
                <DrawerHeader className="px-0">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <DrawerTitle className="text-2xl">{career.career_name}</DrawerTitle>
                ...
                <div className="grid grid-cols-3 gap-4 my-6">
                  ...
                  <div className="text-center p-4 rounded-xl bg-success/5 border border-success/10">
                    ...
                    <div className="text-xs text-muted-foreground mt-1">Skill Fit</div>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-info/5 border border-info/10">
                    <div className="text-3xl font-bold text-info">
                      {Math.round(career.interest_fit_score)}%
                    </div>
                    <div className="text-xs text-muted-foreground mt-1">Interest Fit</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">Bachelor's Degree</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                    ...
                    {career.required_skills?.map((skill, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={hasIt ? "text-success" : "text-foreground"}>
                            {skill}
                          </span>
                          {hasIt && (
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {career.ai_roadmap.steps.map((step, index) => (
                        <div 
                          key={index}
                          className="relative pl-6 pb-4 border-l-2 border-primary/30 last:border-transparent"
                        >
